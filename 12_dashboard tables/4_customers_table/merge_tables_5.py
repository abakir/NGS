...
df = pd.read_csv(cfg['root']+cfg['customers_table']+cfg['customers_segments'])
df1 = pd.read_csv(cfg['root']+cfg['customers_table']+cfg['latest_order'])
df3 = pd.read_csv(cfg['root']+cfg['customers_table']+cfg['frequency'])
df5 = pd.read_csv(cfg['root']+cfg['customers_table']+cfg['customer_days_time'])
...
df2 = pd.read_csv(cfg['root']+cfg['data']+cfg["customers"])
...
df3 = pd.read_csv(cfg['root']+cfg['monthly_segments']+cfg['cust_score'])
