...
f.write("\nfget_day_hour_purchases: /1_get_day_hour_purchases.py")
f.write("\nfget_info_segments: /2_get_info_segments.py")
f.write("\nfget_latest_order_days: /3_get_latest_order_days.py")
f.write("\nfget_order_frequency_customer: /4_get_order_frequency_customer.py")
f.write("\nfmerge_tables: /5_merge_tables.py")
