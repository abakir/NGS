...
#code file names
f.write("\nbought_together_all: bought_together_all")
f.write("\nmonthly_bought_together: monthly_bought_together")
f.write("\nretention_calc: retention_calc")
f.write("\nget_customer_dates: get_customer_dates")
f.write("\nget_day_hour_purchases: get_day_hour_purchases")
f.write("\nget_info_segments: get_info_segments")
f.write("\nget_latest_order_days: get_latest_order_days")
f.write("\nget_order_frequency_customer: get_order_frequency_customer")
f.write("\nmerge_tables: merge_tables")
f.write("\nget_order_frequency: get_order_frequency")
f.write("\nget_products_table: get_products_table")
f.write("\nget_products_dates: get_products_dates")
f.write("\nRevenue_by_type_code: Revenue_by_type_code")
f.write("\nunfulfilled_orders_week: unfulfilled_orders_week")
f.write("\nunfulfilled_orders_yr: unfulfilled_orders_yr")
f.write("\nyear_to_date_code: year_to_date_code")
...
f.write("\nfget_day_hour_purchases: /get_day_hour_purchases.py")
f.write("\nfget_info_segments: /get_info_segments.py")
f.write("\nfget_latest_order_days: /get_latest_order_days.py")
f.write("\nfget_order_frequency_customer: /get_order_frequency_customer.py")
f.write("\nfmerge_tables: /merge_tables.py")
